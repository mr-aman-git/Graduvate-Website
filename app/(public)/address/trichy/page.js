...
export default function TrichyLandingPage() {
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800 selection:bg-red-100 selection:text-red-900">
      <Head>
        <title>
          Study MBBS in Trichy | Top Medical Colleges & Admission Guidance
        </title>
        <meta
          name="description"
          content="Get expert guidance for MBBS admissions in Trichy. Discover top medical colleges, fee structures, and direct admission processes with StudyMBBS."
        />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-3/5 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <a
                href="https://wa.me/+91 9384381372"
                target="_blank"
                rel="noreferrer"
      ...
      <section className="py-16 bg-slate-50 border-t border-gray-100">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full h-120 rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)] border-4 border-white relative z-10 bg-gray-200">
            <iframe
              title="StudyMBBS Trichy Location"
